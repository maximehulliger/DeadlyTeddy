 ...
 * 
 * First you have to load the correct dialogue file. This can be done using EasyDialogueManager.LoadDialogueFile. This returns a manager that contains all the dialogues in the selected file.
 ...
 * \code
 *      manager = EasyDialogueManager.LoadDialogueFile(dialogueFile);
...
/// <summary>
/// The EasyDialogueManager is the main class to interface with the stored dialogues.
/// <example>
/// How to get a dialogue from script
/// <code>
/// EasyDialogueManager manager = EasyDialogueManager.LoadDialogueFile(dialogueFile);
...
{
    private static Dictionary<DialogueFile, EasyDialogueManager> managers = new Dictionary<DialogueFile, EasyDialogueManager>();

    /// <summary>
    /// Load a dialogue file from the resources folder.
    /// </summary>
    /// <param name="resourcePath">The path in the Resource folder</param>
    /// <returns>A EasyDialogueManager holding the file reference</returns>
